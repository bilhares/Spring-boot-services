...
import com.projeto.repository.PortariaRepository;

@RestController
@RequestMapping("/pessoas")
public class PessoaResource {
	@Autowired
	private PortariaRepository pessoaRepository;
...
/*	@PostMapping
	...
	List<Pessoa> findByFiltro(@PathVariable("filtro") String endereco) {
